				...
				<div class="block-bd clearfix">
					<div class="security_tips">
						<div class="block-title">
							<h2>
								<strong>解决方案详细信息</strong>
							</h2>
							<a class="more" href="<%=path%>/web/index/solutionsList.do"
								data-stats="security-system.more">返回&gt;&gt;</a>
						</div>
						<div class="content">
							<h1 style="text-align:center;">
								<strong>${solutions.title}</strong>
							</h1>
							<p>
									${solutions.content }
							</p>
									...
									<ul >
										...
										<c:choose>
											...
											class="avatar" data-stats="mblog-updates.0-avatar">
													<img src="<%=path %>/images/apple.jpg" height="50" width="50">
											</a>

											<p class="mblog">
												<a href="<%=path %>/web/index/productList.do?pcid=${pc.productcategoryid}" 
													title="${product.title }" data-stats="mblog-updates.2-nickname" style="font-size: 18px;">${pc.name }</a>
											</p>
										</li>

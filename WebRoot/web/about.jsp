		...
		<div class="layout block">
			...
			<div class="left">
				...
				<div class="block-bd clearfix"  >
					<div class="security_tips" style="height:100%;overflow:hidden;">
					...
					<div class="blog-question" style="height: 500px;">
						<div class="layout-side-wrap">
							<div class="layout-column" id="mblog-updates" style="height: 300px;" >
								...
								<div id="blog_tips">
									<ul >
										<c:forEach var="info" items="${infos}"  varStatus="cou">
										<c:choose>
											...
											<a href="<%=path %>/web/index/about.do?infoid=${info.infoid}" >
												<span style="font-size:16px;">${info.title }</span>
											</a>
